...
<html lang="en">
    ...
    <body>
        <div id="receiptContainer" style="width: 620px;padding-bottom: 50px;padding-top: 20px;border: 1px solid #d0d0d0;margin:0 auto;border-radius: 5px:padding-left: 10px;padding-right: 10px;">
            <h3 style="font-size: 16px;color: #828282;text-align: right;border-bottom: 1px solid #cccccc;padding-bottom: 10px;marging-top: 10px">Original Receipt</h3>
            <div>
                <table>
                    <tbody>
                        <tr>
                            <td><h3 style="font-size: 27px;text-transform: uppercase;color:rgba(12, 176, 241, 0.97)">Zawadi Milk Dairies</h3></td>
                        </tr>
                        <tr>
                            <td><span style="font-weight: bold;font-size: 13px;">Address: </span>Nairobi</td>
                        </tr>
                        <tr>
                            <td><span style="font-weight: bold;font-size: 13px;">City: </span>Nairobi</td>
                        </tr>
                        <tr>
                            <td><span style="font-weight: bold;font-size: 13px;">Postal: </span>20-0022</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="50%" style="vertical-align: top;">
                                <table>
                                    <tbody>
                                        <tr>
                                            <td><span style="font-size: 15px;text-transform: uppercase;">Order Details: </span></td>
                                        </tr>
                                        <tr>
                                            <td><span style="font-weight: bold;margin-left: 9px;font-size: 13px;">Receipt #: </span><?= $sale['id'] ?></td>
                                        </tr>
                                        <tr>
                ...
                <table style="width: 100%;">
                    <tbody> 
                        <tr>
                            ...
                            <td style="border: 1px solid #bbbbbb; border-collapse: collapse;width:20%;font-size: 12px;font-weight: bold;text-align: center;">Product Name</td>
                            <td style="border: 1px solid #bbbbbb; border-collapse: collapse;width:30%;font-size: 12px;font-weight: bold;text-align: center;">Ordered Qty</td>
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid #bbbbbb; border-collapse: collapse;font-size: 13px;text-align: center">Ksh. <?= number_format($item['unit_price'], 2, '.' , ',') ?></td>
                            <td style="border: 1px solid #bbbbbb; border-collapse: collapse;font-size: 13px;text-align: center">Ksh. <?= number_format($item['sub_total'], 2, '.' , ',') ?></td>
                        </tr>
                        <?php $counter++; } ?>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid #bbbbbb; border-collapse: collapse;font-size: 14px;text-align: center;font-weight: bold;">Ksh. <?= number_format($sale['total_amount'], 2, '.', ',') ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
                            ...
                            <td style="border: 1px solid #bbbbbb; border-collapse: collapse;font-size: 14px;text-align: center;font-weight: bold;">Ksh. <?= number_format($sale['amount_tendered'], 2, '.', ',') ?></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
                            ...
                            <td style="border: 1px solid #bbbbbb; border-collapse: collapse;font-size: 14px;text-align: center;font-weight: bold;">Ksh. <?= number_format($sale['change_amt'], 2, '.', ',') ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
